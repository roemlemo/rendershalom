export const prayersContent = {
    "ovima-001": `¡Oh Virgen Inmaculada, Madre del verdadero Dios y Madre de la Iglesia! Tú, que desde este lugar manifiestas tu clemencia y tu compasión a todos los que solicitan tu amparo: escucha la oración que con filial confianza te dirigimos, y preséntala ante tu Hijo Jesús, único Redentor nuestro. 
...
Virgen de Guadalupe, Madre de las Américas, te pedimos por todos los Obispos, para que conduzcan a los fieles por senderos de intensa vida cristiana, de amor y de humilde servicio a Dios y a las almas. Contempla esta inmensa mies, e intercede para que el Señor infunda hambre de santidad en todo el pueblo de Dios, y otorgue abundantes vocaciones de sacerdotes y religiosas, fuertes en la fe y celosos dispensadores de los misterios de Dios. 
...
Amén.`,
    ...
    "ogcrni-001": `Creo en un solo Dios, Padre todopoderoso, Creador del cielo y de la tierra, de todo lo visible y lo invisible. Creo en un solo Señor, Jesucristo, Hijo único de Dios, nacido del Padre antes de todos los siglos: Dios de Dios, Luz de Luz, Dios verdadero de Dios verdadero, engendrado, no creado, de la misma naturaleza del Padre, por quien todo fue hecho; que por nosotros, los hombres, y por nuestra salvación bajó del cielo, y por obra del Espíritu Santo se encarnó de María, la Virgen, y se hizo hombre; y por nuestra causa fue crucificado en tiempos de Poncio Pilato; padeció y fue sepultado, y resucitó al tercer día, según las Escrituras, y subió al cielo, y está sentado a la derecha del Padre; y de nuevo vendrá con gloria para juzgar a vivos y muertos, y su reino no tendrá fin.
...
Amén.`,
    ...
    "ogmag-001": `Proclama mi alma la grandeza del Señor,y se alegra mi espíritu en Dios, mi Salvador; porque ha mirado la humillación de su esclava.
